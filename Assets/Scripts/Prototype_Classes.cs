...
public class Prototype_Classes : MonoBehaviour
{
    ...
    void f_startstoneSelect()
    {
        ...
        if (Physics.Raycast(shotPoint.position, shotPoint.forward, out m_stoneSelect, 1.9f, 1 << 11) && Input.GetKeyDown("f") && canSelect == true) //Create a raycast that checks for layer 11.
        {
